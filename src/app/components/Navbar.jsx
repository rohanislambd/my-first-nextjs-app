...
const Navbar = () => {
  ...
  const links = <>
        <li><Link className={pathname === '/docs' ? 'text-blue-400':''} href='/docs'>Docs</Link></li>
        ...
        <li><Link className={pathname === '/about/developer'? 'text-blue-500':''} href='/about/developer'>Developers</Link></li>
